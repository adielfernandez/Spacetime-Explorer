...
//                if(pList.size() - numDead < particleThreshold){
        ...
        if(transitionTo2){
            ...
            if(stage1_05_youvecreated.getIsPlaying() == false && ofGetElapsedTimeMillis() - transitionTo2Timer < 1000 && !stage1_03_seehow.getIsPlaying()){
...
//                ofRect(B.x, B.y, B.width, B.height);
        ...
        if(currentTime > 6500 && currentTime < 8000 && !stage2_02_sometimescloud.getIsPlaying()){
            playStage2_02 = true;
            locateClump = true;
        }
